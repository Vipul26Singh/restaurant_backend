<?php
class RestaurantComplaintModel extends CI_Model{
	private $table_name ="tbl_dtl_restaurant_complaint";
	...
	{
		$this->db->select('complaint_id, restaurant_id_fk, complaint_date, complaint, attachement_url, status, mobile_no, email_id, subject');
